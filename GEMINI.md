...
* **Always Record Purchases & Full Hardware Details**: Whenever the user mentions having bought, ordered, or acquired a new device, component, sensor, or tool:
  ...
  2. Record the item with full details into the **Acquired Hardware Table** below, in `AGENTS.md`, in `.agents/rules/hardware_inventory.md`, in [`docs/shopping-list.md`](file:///c:/Users/sacha/src/babystack/docs/shopping-list.md), and in a dedicated guide under [`docs/hardware/`](file:///c:/Users/sacha/src/babystack/docs/hardware/).
